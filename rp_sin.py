# -*- coding: utf-8 -*-
"""
Created on Fri Aug 20 15:48:25 2021
...
time_points = np.arange(0, 2 * np.pi, 0.01)
x = np.sin(time_points)
X = np.array([x]) #single univariate time series input
...
#X contains a single time series (sin over a specified range) and that is why there is a single output recurrence plot X_rp[0]
